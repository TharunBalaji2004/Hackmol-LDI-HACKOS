  ...
  const handlerSubmitMED = async (event) => {
    ...
    try {
      ...
      if (reciept) {
        ...
        const latestCounter = await SupplyChain.methods.getLatestMedicineCounter().call();
        
        console.log("LATEST COUNTER: ", latestCounter);

        const latestData = await SupplyChain.methods.getMedicineData(latestCounter).call();
