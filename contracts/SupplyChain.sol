...
contract SupplyChain {
    ...
    function getMedicineData(uint256 _medicineCounter) public view returns (
        uint256 id,
        string memory name,
        ...
        require(_medicineCounter > 0 && _medicineCounter <= medicineCtr, "Invalid medicine counter");
        
        medicine memory med = MedicineStock[_medicineCounter];
    ...
    function getLatestMedicineCounter() public view returns (uint256) {
        return medicineCtr;
    }
}
